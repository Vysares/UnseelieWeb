/* ============================================================
   ...
   by product id here in the browser. When the Cloudflare reviews
   database is live, point REVIEWS_URL at the API route and have it
   return only that product's reviews; the record shape is unchanged:

     { reviews: [ { id, productId, rating, title, body,
