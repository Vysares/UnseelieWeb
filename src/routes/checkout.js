/* ============================================================
   Unseelie Workshop — Stripe Checkout
   Route: POST /api/checkout  (dispatched from src/index.js)

   Environment variable required (wrangler secret put STRIPE_SECRET_KEY):
...
/* Ordering is switched off while the shop is not taking orders. The Stripe
   ...
   public/js/cart.js to turn it back on. */
